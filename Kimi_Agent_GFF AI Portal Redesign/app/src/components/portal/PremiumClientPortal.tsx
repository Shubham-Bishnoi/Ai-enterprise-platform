...
import type { ClientType } from "@/data/portalDemoData";
import { getClientData } from "@/data/portalDemoData";
...
export default function PremiumClientPortal({
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#030305] text-white">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-16 py-8 lg:py-12 space-y-8">
        {/* Portal Header */}
        <PortalHeader
          data={clientData}
        ...
        <div
          key={clientType}
          className={`space-y-8 transition-all duration-400 ${
