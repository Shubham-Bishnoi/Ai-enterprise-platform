...
import type { DocumentData } from "@/data/portalDemoData";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {documents.map((doc, index) => {
          ...
          return (
            <div
              key={doc.name}
              className="flex items-start gap-3 rounded-2xl border border-white/[0.06] bg-white/[0.03] p-4 cursor-pointer transition-all duration-200 hover:border-white/[0.12] hover:bg-white/[0.05] hover:-translate-y-px"
              style={{
