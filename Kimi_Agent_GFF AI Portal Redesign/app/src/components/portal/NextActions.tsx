...
import type { ActionData } from "@/data/portalDemoData";
        ...
        {actions.map((action, index) => {
          ...
          return (
            <div
              ...
              className="group cursor-pointer rounded-[18px] border border-white/[0.08] bg-white/[0.03] p-5 transition-all duration-300 hover:bg-white/[0.06] hover:-translate-y-0.5 hover:shadow-glass-elevated relative overflow-hidden"
              style={{
            ...
            >
              ...
              {/* Description */}
              <p className="text-[0.8125rem] text-[#A1A1AA] leading-relaxed mb-3">
                {action.description}
              </p>

              {/* CTA */}
              <div className="flex items-center gap-1 text-xs text-[#71717A] group-hover:text-[#F8FAFC] transition-colors duration-200">
